...
//  String _actionBaseUrl = 'http://mail.simplifying.world/apis/v1.0.1/action/';
  ...
  static String commentArticleAdd = 'comments/add',
      actionArchive = 'article/read-later/action',
      commentList = 'comments/get-list?parentId=',
      commentLike = 'comment/assess-like',
      commentsReply = 'comments/reply/add',

      // 'https://www.mesbro.com/apis/v1.0.1/article/add'
      //     actionDelete = 'assess-like',
      //     actionMoveToTrash = 'article/assess-like',
      //     actionSpam = 'assess-subscription',
      //     // articleComment = ''
