...
import 'package:articles/bloc_patterns/idm_bloc_patterns/register_bloc.dart';
import 'package:articles/screens/idm/register_verify_mobile_number_page.dart';
            ...
            child: ListView(
              children: <Widget>[
                ...
                Container(
                    ...
                    child: TextFormField(
                      validator: (String value) {
                        String _firstnamePattern = "^[A-Za-z0-9._]*\$";
